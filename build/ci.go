...
import (
	...
	"github.com/crytic/medusa-geth/crypto/signify"
	"github.com/crytic/medusa-geth/internal/build"
	"github.com/crytic/medusa-geth/internal/version"
)
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/crytic/medusa-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/crytic/medusa-geth/internal/version.gitDate="+env.Date)
	}
...
func doCheckBadDeps() {
	baddeps := [][2]string{
		...
		{"github.com/crytic/medusa-geth/core/rawdb", "github.com/crytic/medusa-geth/ethdb/leveldb"},
		{"github.com/crytic/medusa-geth/core/rawdb", "github.com/crytic/medusa-geth/ethdb/pebbledb"},
	}
	tc := new(build.GoToolchain)
